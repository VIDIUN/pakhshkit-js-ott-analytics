import '../../src/index';
import {loadPlayer, Error, FakeEvent, EventType} from 'pakhshkit-js';
...
describe('OttAnalyticsPlugin', function() {
        ...
        hls: [
          {
            id: '397008,applehttp',
            url:
              '//api-preprod.ott.vidiun.com/v4_7/api_v3/service/assetFile/action/playManifest/partnerId/198/assetId/258457/assetType/media/assetFileId/397008/contextType/TRAILER/a.m3u8',
  ...
  beforeEach(function() {
    ...
    config.plugins.ottAnalytics.vs = config.session.vs;
